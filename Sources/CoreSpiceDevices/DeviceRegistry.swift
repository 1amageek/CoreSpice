...
public struct DeviceRegistry: Sendable {
    ...
    public static func standard() -> DeviceRegistry {
        ...
        registry.register(MutualInductanceDescriptor())
        ...
        registry.register(BranchReferencedCCVSDescriptor())
        registry.register(BranchReferencedCCCSDescriptor())
        ...
        registry.register(PMOSL2Descriptor())
        registry.register(NMOSL3Descriptor())
        registry.register(PMOSL3Descriptor())
        registry.register(NJFETDescriptor())
