...
/// Descriptor for a current-controlled current source that references an existing source branch.
public struct BranchReferencedCCCSDescriptor: DeviceDescriptor, Sendable {

    public let typeName = "cccs_ref"
    ...
    public func bind(instance: Instance, context: inout BindingContext) throws -> any BoundDevice {
        ...
        let gain = try realParameter(instance: instance, name: "f")
        ...
        return BoundBranchReferencedCCCS(
            instance: instance,
