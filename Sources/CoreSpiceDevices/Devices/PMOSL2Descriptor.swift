...
/// Descriptor for a PMOS Level 2 MOSFET.
///
/// Adds mobility degradation (`theta`) and DIBL (`eta`) to the
/// Level 1 square-law model with PMOS polarities.
public struct PMOSL2Descriptor: DeviceDescriptor, Sendable {

    public let typeName = "pmos_l2"
